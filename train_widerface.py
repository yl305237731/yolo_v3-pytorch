...
from tools.widerface_data import WiderFaceDataset, labels
...
if __name__ == '__main__':
    ...
    trainSet = WiderFaceDataset(img_root="", label_path="", target_size=(416, 416), name_list=labels, anchors=anchors,
                                shuffle=True, transform=transform, augmentation=augmentation)
